            ...
            <div className="px-[6%] z-[500] mt-5">
                <div className="p-4 rounded-xl bg-[#252423] shadow-sm shadow-[#935EDB]">
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                        {
                            data.map((d, i) => (
                                <div key={i} onClick={()=>handleclick(d)} className='flex flex-row items-center justify-between p-1 px-2 rounded-[32px] gap-4 w-full border-white border-opacity-20  border-[1px] r'>
